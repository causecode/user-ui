...
import { ISignupData, ILoginData, IUserBasicData } from '../interfaces';
...
export declare class UserModel extends BaseModel {
    ...
    static resetPassword(url: string, token: string, email: string, password: string, password2: string): AxiosPromise<{}>;
