...
var UserListPageImpl = (function (_super) {
    ...
    UserListPageImpl.prototype.render = function () {
        return (React.createElement("div", { style: listContainer },
            ...
            React.createElement(react_hero_1.PagedList, { max: 10, resource: UserListPageImpl.resourceName, totalCount: this.props.totalCount, userActionsMap: this.userActions, pageHeader: this.pageTitle, showDefaultActions: false },
