...
var ReusableComponents_2 = require("../ReusableComponents");
                ...
                React.createElement(ReusableComponents_1.Grid, { style: this.props.gridStyle },
                    ...
                    React.createElement(ReusableComponents_1.FormGroup, null,
                        React.createElement(ReusableComponents_1.Col, { sm: 4, smOffset: 3 },
                            ...
                            React.createElement(ReusableComponents_2.Link, { style: this.props.cancelButtonStyle || defaultButtonStyles, className: "btn btn-default", to: '/userManagement/list' }, "Cancel")))))));
    };
    return UserEditPage;
}(React.Component));
