...
var LoginPanelImpl = (function (_super) {
    ...
    function LoginPanelImpl() {
        ...
        _this.submitForm = function (event) {
            ...
            var _a = _this.props, onSubmit = _a.onSubmit, onLoginSuccess = _a.onLoginSuccess, history = _a.history;
            ...
            if (!email && !password) {
                ...
                UserModel_1.UserModel.login(onSubmit, requestData, onLoginSuccess, history);
            }
        };
