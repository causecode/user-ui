...
var SignupPanelImpl = (function (_super) {
    ...
    function SignupPanelImpl() {
        ...
        _this.submitForm = function () {
            var _a = _this.props, userData = _a.userData, onSubmitUrl = _a.onSubmitUrl, onSuccess = _a.onSuccess, history = _a.history;
            ...
            error ? utils_1.dispatchToStore(signupAction_1.updateSignupError(error)) : UserModel_1.UserModel.signup(onSubmitUrl, userData, onSuccess, history);
        };
...
var SignupPanel = react_router_1.withRouter(react_redux_1.connect(mapStateToProps)(SignupPanelImpl));
