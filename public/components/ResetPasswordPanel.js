...
var ResetPasswordPanel = (function (_super) {
    ...
    function ResetPasswordPanel() {
            ...
            if (!newPassword) {
                ...
                UserModel_1.UserModel.resetPassword(_this.props.onSubmitUrl, token, email, newPassword, confirmPassword)
                    ...
                    if (_this.props.successUrl) {
                        react_router_1.browserHistory.push(_this.props.successUrl);
                    }
        ...
        _this.handleLoginButton = function () {
            react_router_1.browserHistory.push(_this.props.onLoginUrl || 'login');
        };
    ...
    ResetPasswordPanel.prototype.render = function () {
...
exports.ResetPasswordPanel = ResetPasswordPanel;
