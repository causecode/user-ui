...
var RolesModalImpl = (function (_super) {
    ...
    function RolesModalImpl() {
        ...
        _this.renderRolesChecklist = function () {
            var roleList = _this.props.roleList || constants_1.rolesList;
            return roleList.map(function (item, index) {
                return (React.createElement(ReusableComponents_1.Checkbox, { id: "" + item.id, onChange: _this.updateRoles, key: index, style: palette_1.listItem }, item.authority));
            });
        };
    ...
    RolesModalImpl.prototype.render = function () {
        return (React.createElement(ReusableComponents_1.Modal, { onHide: this.hideModal, show: this.props.visibility, backdrop: "static" },
            React.createElement(ReusableComponents_1.ModalHeader, null, "Please select the roles:"),
            React.createElement(ReusableComponents_1.ModalBody, null,
            ...
            React.createElement(ReusableComponents_1.ModalFooter, null,
